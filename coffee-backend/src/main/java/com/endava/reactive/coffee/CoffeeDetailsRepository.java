...
public class CoffeeDetailsRepository {
    ...
    public String getDetailsFor(String coffeeName) {
        return coffeeDetails.getOrDefault(coffeeName.toLowerCase(), "No details for you!");
    }
}
